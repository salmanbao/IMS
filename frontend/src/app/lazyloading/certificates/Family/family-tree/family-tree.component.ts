...
export class FamilyTreeComponent implements AfterViewInit {
  ...
  familyNumber = new FormControl('', null);
  myDiagram: any;
  bluegrad = "#ed4c49";
  pinkgrad = "#00cae3";
  ...
  genderBrushConverter(gender) {
    if (gender === "M") return this.bluegrad;
    if (gender === "F") return this.pinkgrad;
    return "orange";
  }
  ...
  ngAfterViewInit() {
      ...
      MAKE(go.Diagram, diagramDiv,
        {
          ...
          layout: MAKE(go.TreeLayout,
            { angle: 90, layerSpacing: 40, nodeSpacing: 10, layerStyle: go.TreeLayout.LayerUniform })
        });
    ...
    this.myDiagram.nodeTemplate =
      MAKE(go.Node, "Auto",
        ...
        MAKE(go.Shape, "RoundedRectangle",
          ...
          new go.Binding("fill", "gender", (v: string) => { return v == "M" ? "#ed4c49" : "#00cae3"; })),
        MAKE(go.TextBlock,
          {
    ...
    this.myDiagram.linkTemplate =
      MAKE(go.Link,
        ...
        MAKE(go.Shape, { strokeWidth: 3, stroke: '#3f51b5' }));
